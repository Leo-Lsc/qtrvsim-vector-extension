...
enum InstructionFlags : unsigned {
    ...
    IMF_VECTOR = 1L << 25, /**< Instruction is part of the vector extension */
    IMF_V_REGWRITE = 1L << 26, /**< Instruction result (ALU or memory) is written to vector destination register */
    IMF_ALU_REQ_VS1 = 1L << 27, /**< Execution phase/ALU requires VS1 value */
    IMF_ALU_REQ_VS2 = 1L << 28, /**< Execution phase/ALU requires VS2 value */
    IMF_ALU_REQ_VS3 = 1L << 29, /**< Execution phase/ALU requires VS3 value */
    IMF_SCALAR = 1L << 30,     /**< The second ALU source is scalar immediate operand */
    IMF_V_MUL = 1L << 31,      /**< Vector Multiplication */
};
...
public:
    ...
    enum Type { R, I, S, B, U, J, ZICSR, AMO, UNKNOWN, VOP, VL, VS, VRED}; // Add VOP, VL, VS, VRED
    ...
    uint8_t vs1() const; // Add vs1
    uint8_t vs2() const; // Add vs2
    uint8_t vs3() const; // Add vs3
    uint8_t vd() const; // Add vd
