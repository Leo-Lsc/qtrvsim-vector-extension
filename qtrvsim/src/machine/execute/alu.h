...
[[gnu::const]] uint32_t vsetvl_operate(
    RegisterValue avl,
    RegisterValue vtype);

[[gnu::const]] std::array<RegisterValue, 32> vlw_v_operate( // vlw.v vd, (rs1)
    RegisterValue base,
    RegisterValue offset,
    uint32_t vl);

[[gnu::const]] std::array<RegisterValue, 32> vsw_v_operate( // vsw.v vs3, (rs1)
    RegisterValue base,
    RegisterValue offset,
    uint32_t vl);

[[gnu::const]] std::array<RegisterValue, 32> vadd_vv_operate(
    std::array<RegisterValue, 32> vs2,
    std::array<RegisterValue, 32> vs1,
    uint32_t vl);

[[gnu::const]] std::array<RegisterValue, 32> vadd_vx_operate(
    std::array<RegisterValue, 32> vs2,
    RegisterValue rs1,
    uint32_t vl);

[[gnu::const]] std::array<RegisterValue, 32> vadd_vi_operate(
    std::array<RegisterValue, 32> vs2,
    RegisterValue imm,
    uint32_t vl);

[[gnu::const]] std::array<RegisterValue, 32> vmul_vv_operate(
    std::array<RegisterValue, 32> vs2,
    std::array<RegisterValue, 32> vs1,
    uint32_t vl);

[[gnu::const]] RegisterValue vred_operate(
    std::array<RegisterValue, 32> vs2,
    uint32_t vl);
