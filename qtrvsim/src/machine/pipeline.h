...
struct DecodeInterstage {
    ...
    bool v_inst = false; // Determine whether it is a Vector instruction
    ...
    std::array<RegisterValue, 32> val_vs1 = {}; // Value from vector register vs1
    std::array<RegisterValue, 32> val_vs2 = {}; // Value from vector register vs2
    std::array<RegisterValue, 32> val_vs3 = {}; // Value from vector register vs3
    ...
    RegisterId num_vs1 = 0;                         // Number of the vector register vs1
    RegisterId num_vs2 = 0;                         // Number of the vector register vs2
    RegisterId num_vs3 = 0;                         // Number of the vector register vs3
    RegisterId num_vd = 0;                          // Number of the vector register vd
    ...
    bool v_regwrite = false; // If output should be written back to vector register

    bool alu_req_rs = false;  // requires rs value for ALU
    bool alu_req_rt = false;  // requires rt value for ALU or SW

    bool alu_req_vs2 = false;  // requires vs2(rs) value for ALU
    bool alu_req_vs1 = false;  // requires vs1(rt) value for ALU
    bool alu_req_vs3 = false;  // requires vs3 value for VSW
    bool v_mul = false;       // Vector multiplication
...
struct ExecuteInterstage {
    ...
    std::array<RegisterValue, 32> v_alu_val = {};
...
struct ExecuteInternalState {
    ...
    // std::array<RegisterValue, 32> v_alu_src1 = {};
    // std::array<RegisterValue, 32> v_alu_src2 = {};
...
struct MemoryInterstage {
    ...
    std::array<RegisterValue, 32> towrite_v_val = {};
    ExceptionCause excause = EXCAUSE_NONE;
    RegisterId num_rd = 0;
    RegisterId num_vd = 0;
    bool memtoreg = false;
...
struct WritebackInternalState {
    ...
    RegisterId num_rd = 0;
    std::array<RegisterValue, 32> v_value = {};
    RegisterId num_vd = 0;
    bool regwrite = false;
    bool v_regwrite = false;
    bool memtoreg = false;
